...
#get_user_average_age = list("age", users)
#count = len("age", users)

#average = get_user_average_age /count

#print(average)
  

#sum_list = sum("age", users)

#get_user_average_age = sum_list/len(users)
#print(get_user_average_age)

#filter_dog_owners = list(filter(lambda x: x["hasDog"] == True, users))
#print(filter_dog_owners)